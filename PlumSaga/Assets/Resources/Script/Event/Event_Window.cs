...
public class Event_Window : MonoBehaviour {
    ...
    {
        game_Manager.GetComponent<Event_Controller>().OnEventEnd(this.gameObject);
    ...
    {
        plum.GetComponent<Status>().UpdateMoney(Fund);
        plum.GetComponent<Status>().UpdateMemberCount(member_HeadCount);
        plum.GetComponent<Status>().UpdateReputation(Reputation);
        plum.GetComponent<Status>().UpdateMemberStatus(member_Happiness, member_Participation, member_Learning_Point);
